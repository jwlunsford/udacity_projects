...
empire_strikes_back = Movie("The Empire Strikes Back",
...
jason_bourne = Movie("Jason Bourne",
...
the_internship = Movie("The Internship",
...
the_breakfast_club = Movie("The Breakfast Club",
